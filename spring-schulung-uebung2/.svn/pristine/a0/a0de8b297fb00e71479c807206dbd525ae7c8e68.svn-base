...
public class EinfacherHaendler implements Haendler {
	...
	public EinfacherHaendler(int startgeld) {
		vermoegen = taler(startgeld);
	}

	public void setListeners(List<HaendlerListener> listeners) {
		listener = new HaendlerListeners(listeners);
	}
